...
console.log("La Distancia de una Ciudad a otra es:".concat(distancia, " kilometros \n y la Velocidad en la que va por hora es: ").concat(velocidad, " kilometros por hora"));
console.log("El tiempo que tardara en llegar es:".concat(tiempo, " horas"));