...
console.log("La Cantidad de Dias a quedarse es: ".concat(dias));
console.log("El total del Costo del Hotel ser\xE1: ".concat(gastohotel));
console.log("El total del Costo de la Comida ser\xE1: ".concat(gastocomida));
console.log("El total del Costo Extra por d\xEDa ser\xE1: ".concat(gastoextra));
console.log("El total del Cheque ser\xE1: ".concat(total));